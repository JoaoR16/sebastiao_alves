...
if($form2){
    ...
    iduSQL("UPDATE carousel SET titulo='$_GET[titulo]', subtitulo='$_GET[subtitulo]', link_botao='$_GET[link_saber_mais]', data_atualizacao='$data_atual'  WHERE id='$id'");

    iduSQL("UPDATE carousel_mobile SET img='$_GET[link_imagem]' WHERE id_carousel='$id' ");
        ...
        <form class="forms">
            ...
            <?php foreach($dados as $d): ?>
                ...
                <div class="inner-forms">
                    ...
                    <div>
                        <input type="text" name="link_imagem" value="<?= $mobile['img']?>"class="input-imagem">
